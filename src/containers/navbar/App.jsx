...
import "./styles.scss";
import CommmunityPartner from "../CommunityPartner/Community";
  ...
  return (
    <Router>
        ...
        <Wrapper toggle={toggle}>
          <div className="nav-content" ref={navigation}>
            <ul>
              ...
              <li>
                <Link to={"/CommunityPartner"}>
                  <span className="links">Community Partner </span>{" "}
                </Link>
              </li>
              <img
                className="s-close"
      ...
      <Routes>
        ...
        <Route path="/communitypartner" element={<CommmunityPartner />} />
      </Routes>
    </Router>
  );
};
